...
mhealth_test <- mhealth_df %>% filter(group == "By State", time_period == 1, mhealth_ind == "Symptoms of Anxiety Disorder or Depressive Disorder")
...
ui <- fluidPage(
  ...
  sliderInput(inputId = mhealth_map$second_date, label = "Choose a number")
  leafletOutput()
...
server <- function(input, output) {
  ...
  mhealth_map <- mhealth_df %>% filter(group == "By State", time_period == input, mhealth_ind == "Symptoms of Anxiety Disorder or Depressive Disorder")
