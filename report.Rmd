...
Below the choropleth maps that represent the geographic distribution of mental health symptoms and reduced access to care during each survey time period is scatterplot that represents 
